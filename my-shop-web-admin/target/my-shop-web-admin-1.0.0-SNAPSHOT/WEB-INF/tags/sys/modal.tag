...
<%@ attribute name="opts" type="java.lang.String" description="操作类型：info/信息提示 confirm/确认对话框" required="false" %>
<%@ attribute name="url" type="java.lang.String" description="跳转链接，主要用于确定删除" required="false" %>
